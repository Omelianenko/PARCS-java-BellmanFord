...
/**
 * TCP-сервер для приема запросов
 * Запросы обрабатываются функциями HostsServer.java
 */
public class TCPHostsServer extends Thread {
    ...
    public TCPHostsServer() {
        hserver = new HostsServer();
    }

    public TCPHostsServer(List c) {
        hserver = new HostsServer(c);
    }
    ...
    public HostsServer getServerModel() {
        return hserver;
    }
